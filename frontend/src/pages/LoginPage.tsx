      ...
      <div className="w-full max-w-md mx-4">
        <div className="bg-white rounded-2xl shadow-card p-8">
          ...
          <div className="flex rounded-xl bg-surface-100 p-1 mb-6">
            <button
              onClick={() => { setMode('oauth'); setLoginError(''); }}
          ...
          {mode === 'admin' && (
            <form onSubmit={handleAdminLogin} className="space-y-4">
              <div>
                <label htmlFor="admin-email" className="block text-sm font-medium text-surface-700 mb-1">
                  Email
                </label>
                <input
                  id="admin-email"
              ...
              <div>
                <label htmlFor="admin-password" className="block text-sm font-medium text-surface-700 mb-1">
                  Password
                </label>
                <input
                  id="admin-password"
