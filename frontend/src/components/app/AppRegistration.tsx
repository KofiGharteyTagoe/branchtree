...
export default function AppRegistration({ onRegistered }: AppRegistrationProps) {
  ...
  return (
    <div className="card-static max-w-lg animate-fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        {/* App ID */}
        <div>
          <label htmlFor="appId" className="block text-sm font-medium text-gray-700 mb-1.5">
        ...
        {providerConfig.needsRepoUrl && (
          <div>
            <label htmlFor="repoUrl" className="block text-sm font-medium text-gray-700 mb-1.5">
        ...
        {/* PAT / Credentials */}
        <div>
          <label htmlFor="pat" className="block text-sm font-medium text-gray-700 mb-1.5">
        ...
        {/* App Name */}
        <div>
          <label htmlFor="appName" className="block text-sm font-medium text-gray-700 mb-1.5">
